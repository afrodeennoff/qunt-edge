    ...
    return (
      <div className="flex h-full items-center justify-center bg-transparent px-2 py-1 overflow-hidden">
        <div className="mx-auto inline-flex max-w-full items-center justify-center gap-2 text-center">
          ...
          <span className="shrink-0 text-[12px] font-bold uppercase tracking-[0.12em] text-muted-foreground/85 whitespace-nowrap">Streak</span>
          <span className="font-terminal shrink-0 whitespace-nowrap text-center text-[26px] font-black leading-none tracking-tight text-foreground/95">{winningStreak}</span>
