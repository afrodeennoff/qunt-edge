        ...
        <Card className="h-full flex flex-col overflow-hidden border-border/60 bg-card/95 backdrop-blur-xl relative group">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-4 pt-4">
                <div className="space-y-1">
                    <CardTitle className="text-sm font-semibold uppercase tracking-[0.12em] flex items-center gap-2">
                        <Brain className="h-4 w-4 text-primary" />
                        {t('widgets.smartInsights.title')}
                    </CardTitle>
                    <CardDescription className="text-xs text-muted-foreground uppercase tracking-[0.1em]">
