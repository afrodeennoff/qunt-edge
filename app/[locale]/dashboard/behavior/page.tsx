...
export default function DashboardBehaviorPage() {
  ...
  return (
    <div className="enterprise-grid w-full space-y-6 p-3 sm:p-4 lg:p-6">
      <Card className="enterprise-shell rounded-3xl">
        <CardHeader className="pb-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Brain className="h-5 w-5 text-zinc-100" />
                <CardTitle className="text-xl text-zinc-50 md:text-2xl">Behavior AI Hub</CardTitle>
                <Badge variant="secondary" className="border-white/20 bg-white/10 text-zinc-100">
        ...
        <CardContent className="pt-0">
          ...
          <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
            <div className="enterprise-panel rounded-xl p-3">
      ...
      <Tabs defaultValue="insights" className="space-y-4">
        <TabsList className="h-auto rounded-2xl border border-white/15 bg-black/35 p-1">
