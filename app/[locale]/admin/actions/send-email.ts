...
function getDefaultSubject(template: EmailTemplate, language: string): string {
  const subjects: Record<EmailTemplate, { en: string; fr: string }> = {
    "black-friday": {
      en: "Black Friday: 50€ off Qunt Edge Lifetime - Until Nov 30th",
      fr: "Black Friday : 50€ de réduction sur Qunt Edge Lifetime - Jusqu'au 30 nov",
    },
    welcome: {
      en: "Welcome to Qunt Edge",
    ...
    "team-invitation": {
      en: "You've been invited to join a team on Qunt Edge",
      fr: "Vous avez été invité à rejoindre une équipe sur Qunt Edge",
    },
    "missing-data": {
      en: "We miss seeing you on Qunt Edge",
      fr: "Vous nous manquez sur Qunt Edge",
    },
    "support-request": {
