    ...
    return (
        <div className="flex min-h-screen w-full bg-background selection:bg-white/20 selection:text-foreground">
            ...
            <SidebarInset className="flex-1 relative overflow-hidden">
                ...
                <div className="relative z-10 flex min-h-screen flex-col enterprise-grid">
                    <header className="sticky top-0 z-40 h-16 border-b border-white/12 bg-black/65 backdrop-blur-xl">
                        <div className="mx-auto flex h-full w-full max-w-[1600px] items-center px-4 sm:px-6 lg:px-8">
                            <div className="flex items-center gap-3">
                                <SidebarTrigger className="md:hidden -ml-1" />
                                <div className="flex flex-col">
                                    <h1 className="text-sm font-bold tracking-wide text-zinc-100">Teams Dashboard</h1>
                                    <span className="text-[10px] font-medium uppercase tracking-widest text-zinc-400">Unified Workspace</span>
                                </div>
                            </div>
                        </div>
                    </header>
