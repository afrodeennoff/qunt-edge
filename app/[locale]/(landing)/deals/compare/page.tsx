    ...
    >
      ...
      <section className="mt-6 grid gap-4 md:grid-cols-3">
          <article className="rounded-xl border border-border bg-card p-5">
            <h3 className="text-base font-semibold text-foreground">1. Set your max first-month spend</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Include evaluation fee, likely reset probability, and platform add-ons. Budget discipline beats promo hype.
            </p>
          </article>
          <article className="rounded-xl border border-border bg-card p-5">
            <h3 className="text-base font-semibold text-foreground">2. Choose drawdown behavior you can execute</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              A stricter threshold can still win if the rules match your intraday risk control habits.
            </p>
          </article>
          <article className="rounded-xl border border-border bg-card p-5">
            <h3 className="text-base font-semibold text-foreground">3. Align payout cadence to your cash plan</h3>
            <p className="mt-2 text-sm text-muted-foreground">
