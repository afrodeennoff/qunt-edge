...
const ChatBotDemo = () => {
  ...
  return (
    <div className="mx-auto h-[calc(100vh-64px)] w-full max-w-5xl px-3 py-4 sm:px-6">
      <div className="enterprise-shell flex h-full flex-col rounded-3xl p-4 sm:p-6">
        {/* Discord Community Section */}
        <a
          href={process.env.NEXT_PUBLIC_DISCORD_INVITATION || '#'}
          target="_blank"
          rel="noreferrer"
          className="enterprise-panel mb-4 block cursor-pointer rounded-2xl p-4 transition-all duration-200 hover:border-white/25 hover:bg-white/10 group"
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="text-zinc-500 transition-colors duration-150 group-hover:text-zinc-200">
        ...
        <Conversation className="enterprise-panel h-full rounded-2xl p-3">
          <ConversationContent>
        ...
        <PromptInput onSubmit={handleSubmit} className="enterprise-panel mt-4 rounded-2xl p-2" globalDrop multiple>
          <PromptInputBody>
            <PromptInputAttachments>
