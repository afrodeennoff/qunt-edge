  ...
  return (
    <section ref={ref} className="relative overflow-hidden px-4 pb-16 pt-28 sm:px-6 sm:pb-24 sm:pt-40 lg:px-8">
      <motion.div style={shouldAnimate ? { opacity } : undefined} className="pointer-events-none absolute inset-0">
        <div className={cn("absolute inset-0 bg-[linear-gradient(to_right,hsl(var(--foreground)/0.03)_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--foreground)/0.03)_1px,transparent_1px)] bg-[size:48px_48px]", isMobile && "bg-[size:34px_34px]")} />
