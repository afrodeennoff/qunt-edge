...
const thorWriteRateLimit = rateLimit({ limit: 30, window: 60_000, identifier: 'thor-store-write', requireDistributedInProduction: true })
const thorReadRateLimit = rateLimit({ limit: 120, window: 60_000, identifier: 'thor-store-read', requireDistributedInProduction: true })
