...
const adminSubscriptionsReadRateLimit = rateLimit({ limit: 120, window: 60_000, identifier: 'admin-subscriptions-read', requireDistributedInProduction: true })
const adminSubscriptionsWriteRateLimit = rateLimit({ limit: 30, window: 60_000, identifier: 'admin-subscriptions-write', requireDistributedInProduction: true })
