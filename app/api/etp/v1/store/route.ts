...
const etpWriteRateLimit = rateLimit({ limit: 30, window: 60_000, identifier: 'etp-store-write', requireDistributedInProduction: true })
const etpReadRateLimit = rateLimit({ limit: 120, window: 60_000, identifier: 'etp-store-read', requireDistributedInProduction: true })
