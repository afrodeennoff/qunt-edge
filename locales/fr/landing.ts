export default {
    landing: {
        ...
        openSource: {
            title: 'Open Source',
            description: 'Qunt Edge s\'engage envers la communauté open source. Explorez nos projets, contribuez au code ou même clonez le dépôt.',
        },
        features: {
        ...
        accordion: {
            ...
            openRoadmap: {
                ...
                description: 'Une fonctionnalité vous manque ? Lancez une discussion, signalez un problème, contribuez au code ou même clonez le dépôt.',
                button: 'Voir les mises à jour',
            },
            security: {
                title: 'Sécurité',
                description: 'Nous prenons la sécurité au sérieux. Découvrez nos mesures de sécurité et comment signaler des vulnérabilités.',
            },
            openSource: {
                title: 'Open Source',
                description: 'Explorez le dépôt {repoName} et contribuez à l\'avenir de l\'analyse de trading.',
        ...
        propfirms: {
            ...
            description: 'Explorez les prop firms suivies par les utilisateurs de Qunt Edge. Consultez les statistiques réelles sur les comptes enregistrés et les performances de payouts.',
