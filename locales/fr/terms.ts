    ...
    terms: {
        ...
        sections: {
            companyInfo: {
                ...
                content: "Qunt Edge est détenu et exploité par TIMON, opérant en tant qu'entreprise individuelle.",
                contact: "Contact : "
            },
            services: {
                title: "2. Services",
                content: "Qunt Edge fournit l'accès à un tableau de bord de plateforme offrant des services d'analyse avancée pour les traders modernes. Nous hébergeons les données des transactions via Supabase, un service conforme SOC 2."
            },
            userAccounts: {
            ...
            subscriptionPayments: {
                ...
                lifetimePlan: {
                    ...
                    description: "Le plan \"À vie\" fournit l'accès au service Qunt Edge pour la durée de vie opérationnelle du service, sous réserve des conditions suivantes :",
                    condition1: "Le plan à vie garantit l'accès pour une période minimale d'un (1) an à compter de la date d'achat.",
                    condition2: "\"À vie\" fait référence à la durée de vie opérationnelle du service Qunt Edge, pas à la durée de vie de l'utilisateur.",
            ...
            intellectualProperty: {
                ...
                content: "Qunt Edge possède tous les droits de propriété intellectuelle liés à notre service. Les utilisateurs ne sont pas autorisés à copier ou reproduire notre service. Notre code est sous licence selon les termes spécifiés dans notre fichier LICENSE, qui est la Licence Publique Générale GNU Affero version 3."
            },
            dataProtection: {
