...
export default {
  ...
  "authentication.testimonial":
    "Qunt Edge helped me understand my trading behaviors, and find new strategies I could earn from.",
  "authentication.testimonialAuthor": "TIMON",
  ...
  "updates.title": "Qunt Edge Product Roadmap",
  "updates.description":
    "We're constantly working to improve Qunt Edge and provide you with the best trading analytics platform. Here's a look at our current progress, upcoming features, and recent updates.",
  ...
  "updates.milestone1.description":
    "We've laid the foundation for Qunt Edge with essential features. You can now process CSV data, view trades on a calendar, and access basic analytics. We've also implemented authentication and migrated to a robust Postgres database.",
  ...
  "updates.milestone6.description":
    "We've implemented a dark mode option, allowing users to comfortably use Qunt Edge in low-light environments and reduce eye strain during extended analysis sessions.",
  ...
  "updates.milestone8.description":
    "We're collaborating closely with Rithmic to implement automatic data import, streamlining the process of getting your trading data into Qunt Edge.",
  "updates.milestone9.title": "Import from Interactive Broker and AMP",
  "updates.milestone9.description":
    "We're expanding our import capabilities to include support for Interactive Broker and AMP, giving you more flexibility in how you bring your trading data into Qunt Edge.",
  ...
  "dashboard.data": "Data",
  "dashboard.refreshData": "Sync Data",
  ...
  "dashboard.logOut": "Terminate Session",
  ...
  "dashboard.tabs.table": "Trades",
  "dashboard.tabs.accounts": "Accounts",
  "dashboard.tabs.widgets": "Dashboard",
  ...
  "widgets.types.tradingScore": "Trading Score",
  "widgets.types.expectancy": "Expectancy",
  "widgets.types.riskMetrics": "Risk Metrics",
  "widgets.types.propFirmCatalogue": "Prop Firms Catalogue",
  "widgets.types.smartInsights": "Smart Insights",
  "widgets.types.mindsetWidget": "Mindset",
  "widgets.tags.title": "Tags",
  "widgets.smartInsights.title": "Smart Insights",
  "widgets.smartInsights.tooltip": "AI-driven trade analysis and opportunities.",
  "widgets.tradingScore.title": "Trading Score",
  "widgets.tradingScore.tooltip": "Overall trading performance score based on win rate, profit factor, and activity.",
  "widgets.expectancy.title": "Expectancy",
  "widgets.expectancy.tooltip": "Average dollar amount expected per trade based on historical performance.",
  "widgets.riskMetrics.title": "Risk Metrics",
  "widgets.riskMetrics.tooltip": "Advanced risk analysis including Kelly Criterion, Sharpe Ratio, Sortino Ratio, and Max Drawdown.",
  "widgets.riskRewardRatio.title": "Risk Reward Ratio",
  "widgets.riskRewardRatio.tooltip": "Average Risk Reward Ratio",
  ...
  "onboarding.welcome": "Welcome to Qunt Edge!",
  ...
  support: {
    greeting:
      "Welcome to the Qunt Edge Support Assistant! I'm here to help you gather all the necessary details about your issue or question. My goal is to collect the right context so your message can be efficiently forwarded to our customer support team, who will follow up with you by email.",
  ...
  maintenance: {
    ...
    email: {
      preview: "New Support Request from Qunt Edge",
