...
export default {
  ...
  "footer.copyright": "© {year} Qunt Edge. Tous droits réservés.",
  ...
  "authentication.testimonial":
    "Qunt Edge m'a aidé à comprendre mes comportements de trading et à trouver de nouvelles stratégies rentables.",
  ...
  "updates.title": "Feuille de route du produit Qunt Edge",
  "updates.description":
    "Nous travaillons constamment à l'amélioration de Qunt Edge pour vous offrir la meilleure plateforme d'analyse de trading. Voici un aperçu de nos progrès actuels, des fonctionnalités à venir et des mises à jour récentes.",
  ...
  "updates.milestone6.description":
    "Nous avons implémenté une option de mode sombre, permettant aux utilisateurs d'utiliser confortablement Qunt Edge dans des environnements peu éclairés et de réduire la fatigue oculaire pendant les longues sessions d'analyse.",
  ...
  "updates.milestone8.description":
    "Nous collaborons étroitement avec Rithmic pour mettre en place l'importation automatique des données, simplifiant le processus d'intégration de vos données de trading dans Qunt Edge.",
  "updates.milestone9.title": "Importation depuis Interactive Broker et AMP",
  "updates.milestone9.description":
    "Nous élargissons nos capacités d'importation pour inclure le support d'Interactive Broker et AMP, vous offrant plus de flexibilité dans la façon dont vous intégrez vos données de trading dans Qunt Edge.",
  ...
  "widgets.types.propFirmCatalogue": "Catalogue des Prop Firms",
  "widgets.types.smartInsights": "Analyses Intelligentes",
  "widgets.smartInsights.title": "Analyses Intelligentes",
  "widgets.smartInsights.tooltip": "Analyses de trading et opportunités basées sur l'IA.",
  ...
  "onboarding.welcome": "Bienvenue sur Qunt Edge !",
  ...
  maintenance: {
    ...
    email: {
      preview: "Nouvelle demande de support de Qunt Edge",
