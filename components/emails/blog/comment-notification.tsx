...
const CommentNotificationEmail = ({
  ...
  commentDate,
  recipientName,
  unsubscribeUrl = 'https://qunt-edge.vercel.app/settings/notifications',
  language = 'fr'
}: CommentNotificationEmailProps) => {
  const t = {
    fr: {
      preview: 'Nouveau commentaire sur votre publication Qunt Edge',
      greeting: 'Bonjour',
      notification: 'Bonne nouvelle ! Quelqu\'un vient de commenter votre publication sur Qunt Edge.',
      article: 'Publication',
      viewComment: 'Voir le commentaire',
      footer: {
        text: 'Qunt Edge - Analyses avancées pour traders modernes',
    ...
    en: {
      preview: 'New comment on your Qunt Edge post',
      greeting: 'Hello',
      notification: 'Great news! Someone just commented on your post on Qunt Edge.',
      article: 'Post',
      viewComment: 'View comment',
      footer: {
        text: 'Qunt Edge - Advanced Analytics for Modern Traders',
