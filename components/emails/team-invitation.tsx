...
const content = {
  en: {
    preview: "You've been invited to join a team on Qunt Edge",
    greeting: "Hello",
    invitation: "You've been invited to join a team on Qunt Edge",
    teamName: "Team Name",
    inviter: "Invited by",
  ...
  fr: {
    preview: "Vous avez été invité à rejoindre une équipe sur Qunt Edge",
    greeting: "Bonjour",
    invitation: "Vous avez été invité à rejoindre une équipe sur Qunt Edge",
  ...
  return (
    <Html>
      ...
      <Tailwind>
        ...
        TIMON
        <br />
        <span className="text-gray-600">Founder of Qunt Edge</span>
      </Text>
