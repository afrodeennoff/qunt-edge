...
const translations = {
  fr: {
    preview: 'Vos statistiques de trading de la semaine - Qunt Edge',
    greeting: 'Bonjour',
    ...
    sentBy: 'Cet email vous a été envoyé par Qunt Edge',
  ...
  en: {
    preview: 'Your weekly trading statistics - Qunt Edge',
    greeting: 'Hello',
    ...
    sentBy: 'This email was sent to you by Qunt Edge',
