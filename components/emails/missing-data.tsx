...
const content = {
  en: {
    preview: "We miss seeing you on Qunt Edge",
    greeting: "Hello",
    notice: "We noticed that you haven't imported your trading data to Qunt Edge yet.",
    ...
    losses: "Losses",
    winRate: "Win Rate",
    could: "With Qunt Edge, you could:",
    features: [
    ...
    startToday: "Start today by importing your data and discover how Qunt Edge can transform your trading approach.",
    importButton: "Import my data →",
    founder: "Founder of Qunt Edge",
    footer: "This email was sent by Qunt Edge",
    unsubscribe: "Unsubscribe",
    days: ["Mon", "Tue", "Wed", "Thu", "Fri"]
  },
  fr: {
    preview: "Nous manquons de vous voir sur Qunt Edge",
    greeting: "Bonjour",
    notice: "Nous avons remarqué que vous n'avez pas encore importé vos données de trading sur Qunt Edge.",
    ...
    could: "Avec Qunt Edge, vous pourriez :",
    features: [
    ...
    startToday: "Commencez dès aujourd'hui en important vos données et découvrez comment Qunt Edge peut transformer votre approche du trading.",
    importButton: "Importer mes données →",
    founder: "Fondateur de Qunt Edge",
    footer: "Cet email vous a été envoyé par Qunt Edge",
      ...
      <Tailwind>
        ...
        <span className="text-gray-600">{t.founder}</span>
              ...
              <Text className="text-gray-400 text-xs text-center">
                ...
                {' • '}
                © {new Date().getFullYear()} Qunt Edge
              </Text>
            </Section>
          </Section>
        </Body>
