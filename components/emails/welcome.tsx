...
export default function WelcomeEmail({ firstName = 'trader', email, language, youtubeId }: WelcomeEmailProps) {
  ...
  if (language === 'fr') {
    return (
      <Html>
        <Head />
        <Preview>Bienvenue sur Qunt Edge - Votre plateforme de suivi de trading</Preview>
        <Tailwind>
            ...
            <Section className="bg-white max-w-[600px] mx-auto rounded-lg shadow-xs">
              <Section className="px-6 py-8">
                ...
                <Text className="text-gray-800 mb-4 leading-6">
                  Ravi de vous compter parmi les utilisateurs de Qunt Edge !
                </Text>
    ...
    return (
      <Html>
        <Head />
        <Preview>Welcome to Qunt Edge - Your trading tracking platform</Preview>
        <Tailwind>
          <Body className="bg-gray-50 font-sans">
            <Section className="bg-white max-w-[600px] mx-auto rounded-lg shadow-xs">
              <Section className="px-6 py-8">
                ...
                <Text className="text-gray-800 mb-4 leading-6">
                  I&apos;m happy to count you among the users of Qunt Edge!
                </Text>
