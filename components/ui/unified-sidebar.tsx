...
> = {
  ...
  glassy: {
    sidebar:
      "border-r border-white/10 bg-black text-white/70",
    ...
    workspaceLabel: "truncate text-[9px] font-mono uppercase tracking-widest text-white/30 mt-1",
    userCard:
    ...
    avatarFallback: "bg-white/5 text-[10px] font-bold text-white/60",
    content: "flex flex-col px-3 py-4 overflow-x-hidden",
    groupLabel: "text-[9px] font-bold uppercase tracking-widest text-white/20 px-3 mb-2 animate-in fade-in slide-in-from-left-2",
    ...
    itemButtonInactive: "hover:bg-white/5 hover:text-white/80 text-white/40",
    selectTrigger:
      "h-9 rounded-lg border-white/10 bg-white/[0.03] text-[12px] font-medium hover:border-white/30 hover:text-white focus:ring-white/30 transition-colors",
    footer: "border-t border-white/5 bg-black p-4",
    logout:
      "flex h-8 w-8 items-center justify-center rounded-lg text-white/20 transition-all duration-200 hover:bg-white/10 hover:text-white ml-auto",
    collapse:
      "flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-white/10 bg-black text-white/30 shadow-lg transition-all duration-200 hover:border-white/30 hover:text-white absolute -right-3 top-8 z-50",
    edgeCollapse:
      "absolute -right-3 top-8 z-50 hidden border border-white/10 bg-black shadow-lg md:flex",
  },
  matte: {
    sidebar: "border-r border-white/5 bg-black text-white/60",
    rail: "after:bg-white/[0.02] hover:bg-white/[0.03] hover:after:bg-white/[0.18]",
    header: "border-b border-white/5 px-4 py-5",
    ...
    workspaceLabel: "truncate text-[9px] font-mono uppercase tracking-[0.2em] text-white/20",
    ...
    avatarFallback: "bg-white/5 text-[10px] font-bold text-white/40",
    content: "flex flex-col px-3 py-6",
    groupLabel: "text-[9px] font-mono font-bold uppercase tracking-[0.2em] text-white/10 px-3 mb-4",
    groupLine: "h-px flex-1 bg-white/5",
    itemTrack: "bg-white/70",
    itemIconActive: "text-white",
    itemIconInactive: "text-white/20 group-hover/item:text-white/40",
    itemButtonActive: "bg-white/[0.02] text-white font-mono",
    itemButtonInactive: "hover:bg-white/[0.01] hover:text-white/80 text-white/30 font-mono",
    selectTrigger: "h-8 rounded-md border-white/5 bg-white/[0.02] text-[11px] font-mono text-white/40 hover:border-white/30",
    footer: "border-t border-white/5 bg-black p-4",
    logout: "flex h-8 w-8 items-center justify-center rounded-lg text-white/20 hover:bg-white/5 hover:text-white ml-auto transition-colors",
    collapse: "flex h-6 w-6 items-center justify-center rounded-md border border-white/5 bg-black text-white/20 hover:border-white/30 hover:text-white absolute -right-3 top-8 z-50",
    edgeCollapse: "absolute -right-3 top-8 z-50 hidden border border-white/5 bg-black md:flex",
  },
}
