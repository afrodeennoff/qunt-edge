  ...
  return (
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        ref={ref}
        className={cn(
          "flex aspect-video justify-center rounded-xl border border-border/60 bg-gradient-to-b from-background/85 to-muted/15 p-1 text-xs [&_.recharts-cartesian-axis-tick_text]:fill-[hsl(var(--chart-axis))] [&_.recharts-cartesian-axis-tick_text]:font-medium [&_.recharts-cartesian-grid_line]:stroke-[hsl(var(--chart-grid)/0.5)] [&_.recharts-cartesian-grid_line]:[stroke-dasharray:3_3] [&_.recharts-curve.recharts-tooltip-cursor]:stroke-[hsl(var(--border))] [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-hidden [&_.recharts-polar-grid_line]:stroke-[hsl(var(--chart-grid)/0.5)] [&_.recharts-radial-bar-background-sector]:fill-muted [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-[hsl(var(--muted)/0.35)] [&_.recharts-reference-line_line]:stroke-[hsl(var(--chart-axis)/0.6)] [&_.recharts-reference-line_line]:[stroke-dasharray:4_4] [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-sector]:outline-hidden [&_.recharts-surface]:outline-hidden",
          className
        )}
        {...props}
      >
